    ...
    class FX : Trade
{
    ...
    public FX(DateTime tradeDate, string stockCode, decimal quantity, string action, decimal price, decimal fees, decimal cost, decimal pnl, decimal tradeLength, string CCY, decimal fxrate, decimal taxpnl, string source)
    {
